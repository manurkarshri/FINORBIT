...
export function createApp({ root, header, navigation, main, statusRegion, liveRegion, securityCenter, onboardingView, entityService, settingsCenter, transactionCenter, wealthCenter, portfolioCenter, physicalAssetsCenter, recurringCenter, householdCenter, planningCenter, reportsCenter, reconciliationCenter }) {
